...
public class CaContract implements ContractInterface {
    ...
    @Transaction
    public String createCa(final Context ctx, String name , String age , String grade, String subject, String university, String issuer) {
    ...
    @Transaction
    public Ca updateCa(final Context ctx, final String key , String name , String age , String grade, String subject, String university, String issuer) {
