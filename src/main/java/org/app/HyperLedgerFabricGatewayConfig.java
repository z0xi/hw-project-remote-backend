...
//        log.info("=========================================== connected fabric gateway {} " , gateway);
    ...
    @Bean
    public Contract caContract(Network network) { return network.getContract("myca"); }

    @Bean
    public ChaincodeEventListener chaincodeEventListener(Network network) { return new ChaincodeEventListener(network); }
}
